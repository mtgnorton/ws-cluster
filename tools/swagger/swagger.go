...
func WrapHandler(h *webdav.Handler, confs ...func(c *Config)) ghttp.HandlerFunc {
...
func CustomWrapHandler(config *Config, handler *webdav.Handler) ghttp.HandlerFunc {
	var once sync.Once
	...
	return func(r *ghttp.Request) {
		...
		switch path {
		case "index.html":
			_ = index.Execute(c.Response.Writer, config.ToSwaggerConfig())
